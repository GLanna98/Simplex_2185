...
void MyRigidBody::AddToRenderList(void)
{
	...
	m_pMeshMngr->AddWireSphereToRenderList(glm::translate(IDENTITY_M4, m_v3CenterG) * glm::scale(vector3(m_fRadius)), m_v3Color, RENDER_WIRE);
	m_pMeshMngr->AddWireCubeToRenderList(glm::translate(IDENTITY_M4, m_v3CenterG) * glm::scale(m_v3HalfWidth * 2.0f), C_BLUE, RENDER_WIRE);
}
